...
if(LUE_BUILD_FRAMEWORK)
    ...
    set(LUE_FRAMEWORK_WITH_INT8_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_SIGNED_INTEGRAL_ELEMENTS "std::int8_t" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_INT8_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_INT16_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_SIGNED_INTEGRAL_ELEMENTS "std::int16_t" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_INT16_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_INT32_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_SIGNED_INTEGRAL_ELEMENTS "std::int32_t" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_INT32_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_INT64_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_SIGNED_INTEGRAL_ELEMENTS "std::int64_t" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_INT64_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_UINT8_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_UNSIGNED_INTEGRAL_ELEMENTS "std::uint8_t" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_UINT8_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_UINT16_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_UNSIGNED_INTEGRAL_ELEMENTS "std::uint16_t" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_UINT16_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_UINT32_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_UNSIGNED_INTEGRAL_ELEMENTS "std::uint32_t" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_UINT32_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_UINT64_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_UNSIGNED_INTEGRAL_ELEMENTS "std::uint64_t" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_UINT64_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_FLOAT32_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_FLOATING_POINT_ELEMENTS "float" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_FLOAT32_ELEMENT TRUE)
    endif()

    set(LUE_FRAMEWORK_WITH_FLOAT64_ELEMENT FALSE)
    LIST(FIND LUE_FRAMEWORK_FLOATING_POINT_ELEMENTS "double" TYPE_PRESENT)
    if(TYPE_PRESENT GREATER_EQUAL 0)
        set(LUE_FRAMEWORK_WITH_FLOAT64_ELEMENT TRUE)
    endif()
