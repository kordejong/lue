...
// namespace lue::cf {
//
//     // auto Variable::is_coordinate(netcdf4::Variable const& variable) -> bool
//     // {
//     //     return kind(variable) == Kind::coordinate;
//     // }
//
//
//     // auto Variable::is_scalar(netcdf4::Variable const& variable) -> bool
//     // {
//     //     return variable.nr_dimensions() == 0;
//     // }
//
//
//     Variable::Variable(netcdf4::Variable const& variable):
//
//         netcdf4::Variable{variable}
//
//     {
//     }
//
...
//     {
//         // TODO Required for all variables that represent dimensional quantities, except for (some)
//         boundary
//         //      variables
