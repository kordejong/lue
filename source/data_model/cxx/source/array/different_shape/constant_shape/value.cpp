...
namespace lue::data_model::different_shape::constant_shape {
    ...
    */
    ...
    auto Value::exists(ID const id) const -> bool
    {
    ...
    /*!
        ...
        For each object a value array is created which contains space for object arrays for the passed in
        number of locations of time.
    ...
    */
    ...
    /*!
        ...
        A value array is created which contains space for object arrays for the passed in number of locations
        of time.
    ...
    */
    ...
    auto Value::operator[](ID const id) const -> same_shape::constant_shape::Value
    {
        std::string const name{std::to_string(id)};
