        ...
        public:
            ...
            */
            ...
            void write(Hyperslab const& hyperslab, T const* values)
            {
                ...
                {
                    throw std::runtime_error(
                        fmt::format("Cannot get write values: {}", error_message(status)));
                }
            }
            ...
            */
            ...
            void write(T const* value)
            {
                if (auto const status = detail::VariableValue<T>::put(_group_id, _variable_id, value);
                    status != NC_NOERR)
                {
                    throw std::runtime_error(fmt::format("Cannot write values: {}", error_message(status)));
                }
            }
            ...
            */
            ...
            void read(Hyperslab const& hyperslab, T* values)
            {
                ...
                {
                    throw std::runtime_error(
                        fmt::format("Cannot get read values: {}", error_message(status)));
                }
            }
