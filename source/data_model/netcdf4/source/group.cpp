...
namespace lue::netcdf4 {
    ...
    */
    auto Group::attribute(std::string name) const -> Attribute
    {
        ...
        {
            throw std::runtime_error(fmt::format("Attribute {} is not available", name));
        }
    ...
    */
    auto Group::attributes() const -> std::vector<Attribute>
    {
        ...
        {
            throw std::runtime_error(
                fmt::format("Cannot get number of group attributes: {}", error_message(status)));
        }
    ...
    */
    auto Group::parent_group() const -> Group
    {
        ...
        {
            throw std::runtime_error(fmt::format("Cannot get parent group: {}", error_message(status)));
        }
    ...
    */
    auto Group::add_child_group(std::string const& name) const -> Group
    {
        ...
        {
            throw std::runtime_error(
                fmt::format("Cannot define child group {}: {}", name, error_message(status)));
        }
    ...
    */
    auto Group::child_group(std::string const& name) const -> Group
    {
        ...
        {
            throw std::runtime_error(
                fmt::format("Cannot get child group {}: {}", name, error_message(status)));
        }
