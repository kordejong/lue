...
namespace {
    ...
    void test_array_1d(lue::netcdf4::Group& group, std::string const& name)
    {
        ...
        auto dimension = group.add_dimension(fmt::format("{}_dimension", name), nr_elements);
    ...
    void test_array_2d(lue::netcdf4::Group& group, std::string const& name)
    {
        ...
        auto dimension1 = group.add_dimension(fmt::format("{}_dimension1", name), nr_elements1);
        auto dimension2 = group.add_dimension(fmt::format("{}_dimension2", name), nr_elements2);
        auto variable = group.add_variable(
            name,
