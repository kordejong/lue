    ...
    namespace detail::open_simplex_noise {
            ...
            int const seed) -> PartitionT<Partition, policy::OutputElementT<Policies, 0>>
        {
            ...
            return hpx::dataflow(
                ...
                [policies, seed](
                    Partition const& x_coordinate_partition,
                    Partition const& y_coordinate_partition) -> Partition
                {
                    AnnotateFunction annotation{"open_simplex_noise: partition"};

                    Offset const offset = x_coordinate_partition.offset(hpx::launch::sync);
                    Data const x_coordinates = x_coordinate_partition.data(hpx::launch::sync);
                    Data const y_coordinates = y_coordinate_partition.data(hpx::launch::sync);
                ...
                x_coordinate_partition,
                y_coordinate_partition);
        }
