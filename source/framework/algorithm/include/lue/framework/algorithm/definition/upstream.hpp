...
namespace lue {
    ...
    /*!
      @brief      Assign the sum of the values from each cell's upstream neighbours to the cell itself
...
#define LUE_INSTANTIATE_UPSTREAM(Policies)                                                                   \
                                                                                                             \
    template LUE_ROUTING_OPERATION_EXPORT auto upstream<ArgumentType<void(Policies)>>(                       \
