...
namespace lue {
    namespace value_policies {
        ...
        auto greater_than_equal_to(auto const& field1, auto const& field2) -> api::Field
        {
            api::detail::unsupported_overload("greater_than_equal_to", field1, field2);
        ...
        auto greater_than_equal_to(Field const& field1, Field const& field2) -> Field
        {
            return std::visit(
                overload{
                    ...
                    { return value_policies::greater_than_equal_to<BooleanElement>(field1, field2); }},
                field1.variant(),
                field2.variant());
        }
