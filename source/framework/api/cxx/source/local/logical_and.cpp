...
namespace lue {
    namespace value_policies {
        ...
        auto logical_and(auto const& field1, auto const& field2) -> api::Field
        {
            api::detail::unsupported_overload("logical_and", field1, field2);
        ...
        auto logical_and(Field const& field1, Field const& field2) -> Field
        {
            return std::visit(
                overload{
                    ...
                    { return value_policies::logical_and<BooleanElement>(field1, field2); }},
                field1.variant(),
                field2.variant());
        }
