...
namespace lue {
    namespace value_policies {
        ...
        auto where(auto const& field1, auto const& field2) -> api::Field
        {
            api::detail::unsupported_overload("where", field1, field2);
    ...
    namespace api {
        ...
        auto where(Field const& field1, Field const& field2) -> Field
        {
            return std::visit(
                overload{
                    [](auto const& field1, auto const& field2) -> Field
                    { return value_policies::where<BooleanElement>(field1, field2); }},
                field1.variant(),
                field2.variant());
        }
