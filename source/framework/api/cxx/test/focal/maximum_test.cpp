#define BOOST_TEST_MODULE lue framework api cxx focal maximum
#include "unit_test.hpp"
#include "lue/framework/api/cxx/focal/maximum.hpp"
#include "lue/framework.hpp"


BOOST_AUTO_TEST_CASE(focal_maximum_raster_kernel)
{
    ...
    lue::api::Field result = lue::api::focal_maximum(raster, kernel);
