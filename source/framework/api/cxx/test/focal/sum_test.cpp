#define BOOST_TEST_MODULE lue framework api cxx focal sum
#include "unit_test.hpp"
#include "lue/framework/api/cxx/focal/sum.hpp"
#include "lue/framework.hpp"


BOOST_AUTO_TEST_CASE(focal_sum_raster_kernel)
{
    ...
    lue::api::Field result = lue::api::focal_sum(raster, kernel);
