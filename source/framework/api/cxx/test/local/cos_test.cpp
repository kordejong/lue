#define BOOST_TEST_MODULE lue framework api cxx local cos
#include "lue/framework/api/cxx/local/cos.hpp"
#include "unit_test.hpp"
#include "lue/framework.hpp"


BOOST_AUTO_TEST_CASE(cos_array)
{
    ...
    {
        lue::api::Field result = lue::api::cos(array);
...
BOOST_AUTO_TEST_CASE(cos_scalar)
{
    using Element = lue::SmallestFloatingPointElement;
    ...
    {
        lue::api::Field result = lue::api::cos(scalar);
...
BOOST_AUTO_TEST_CASE(cos_value)
{
    using Element = lue::SmallestFloatingPointElement;
    using Scalar = lue::Scalar<Element>;
    ...
    {
        lue::api::Field result = lue::api::cos(value);
