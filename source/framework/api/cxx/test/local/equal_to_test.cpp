#define BOOST_TEST_MODULE lue framework api cxx local equal_to
#include "lue/framework/api/cxx/local/equal_to.hpp"
#include "unit_test.hpp"
#include "lue/framework.hpp"


BOOST_AUTO_TEST_CASE(equal_to_array_array)
{
    ...
    {
        lue::api::Field result = lue::api::equal_to(array1, array2);
...
BOOST_AUTO_TEST_CASE(equal_to_array_scalar)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputArray = lue::PartitionedArray<InputElement, 2>;
    ...
    {
        lue::api::Field result = lue::api::equal_to(array, scalar);
...
BOOST_AUTO_TEST_CASE(equal_to_scalar_array)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputScalar = lue::Scalar<InputElement>;
    using InputArray = lue::PartitionedArray<InputElement, 2>;
    ...
    {
        lue::api::Field result = lue::api::equal_to(scalar, array);
...
BOOST_AUTO_TEST_CASE(equal_to_scalar_scalar)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputScalar = lue::Scalar<InputElement>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::equal_to(scalar1, scalar2);
...
BOOST_AUTO_TEST_CASE(equal_to_array_value)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputArray = lue::PartitionedArray<InputElement, 2>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::equal_to(array, value);
...
BOOST_AUTO_TEST_CASE(equal_to_value_array)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputArray = lue::PartitionedArray<InputElement, 2>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::equal_to(value, array);
...
BOOST_AUTO_TEST_CASE(equal_to_scalar_value)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputScalar = lue::Scalar<InputElement>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::equal_to(scalar, value);
...
BOOST_AUTO_TEST_CASE(equal_to_value_scalar)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputScalar = lue::Scalar<InputElement>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::equal_to(value, scalar);
...
BOOST_AUTO_TEST_CASE(equal_to_value_value)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using OutputElement = lue::BooleanElement;
    using OutputScalar = lue::Scalar<OutputElement>;
    ...
    {
        lue::api::Field result = lue::api::equal_to(value1, value2);
