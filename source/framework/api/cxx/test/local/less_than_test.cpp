#define BOOST_TEST_MODULE lue framework api cxx local less_than
#include "lue/framework/api/cxx/local/less_than.hpp"
#include "unit_test.hpp"
#include "lue/framework.hpp"


BOOST_AUTO_TEST_CASE(less_than_array_array)
{
    ...
    {
        lue::api::Field result = lue::api::less_than(array1, array2);
...
BOOST_AUTO_TEST_CASE(less_than_array_scalar)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputArray = lue::PartitionedArray<InputElement, 2>;
    ...
    {
        lue::api::Field result = lue::api::less_than(array, scalar);
...
BOOST_AUTO_TEST_CASE(less_than_scalar_array)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputScalar = lue::Scalar<InputElement>;
    using InputArray = lue::PartitionedArray<InputElement, 2>;
    ...
    {
        lue::api::Field result = lue::api::less_than(scalar, array);
...
BOOST_AUTO_TEST_CASE(less_than_scalar_scalar)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputScalar = lue::Scalar<InputElement>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::less_than(scalar1, scalar2);
...
BOOST_AUTO_TEST_CASE(less_than_array_value)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputArray = lue::PartitionedArray<InputElement, 2>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::less_than(array, value);
...
BOOST_AUTO_TEST_CASE(less_than_value_array)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputArray = lue::PartitionedArray<InputElement, 2>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::less_than(value, array);
...
BOOST_AUTO_TEST_CASE(less_than_scalar_value)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputScalar = lue::Scalar<InputElement>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::less_than(scalar, value);
...
BOOST_AUTO_TEST_CASE(less_than_value_scalar)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using InputScalar = lue::Scalar<InputElement>;
    using OutputElement = lue::BooleanElement;
    ...
    {
        lue::api::Field result = lue::api::less_than(value, scalar);
...
BOOST_AUTO_TEST_CASE(less_than_value_value)
{
    using InputElement = lue::LargestSignedIntegralElement;
    using OutputElement = lue::BooleanElement;
    using OutputScalar = lue::Scalar<OutputElement>;
    ...
    {
        lue::api::Field result = lue::api::less_than(value1, value2);
