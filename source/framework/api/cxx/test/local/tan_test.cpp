#define BOOST_TEST_MODULE lue framework api cxx local tan
#include "lue/framework/api/cxx/local/tan.hpp"
#include "unit_test.hpp"
#include "lue/framework.hpp"


BOOST_AUTO_TEST_CASE(tan_array)
{
    ...
    {
        lue::api::Field result = lue::api::tan(array);
...
BOOST_AUTO_TEST_CASE(tan_scalar)
{
    using Element = lue::SmallestFloatingPointElement;
    ...
    {
        lue::api::Field result = lue::api::tan(scalar);
...
BOOST_AUTO_TEST_CASE(tan_value)
{
    using Element = lue::SmallestFloatingPointElement;
    using Scalar = lue::Scalar<Element>;
    ...
    {
        lue::api::Field result = lue::api::tan(value);
