...
namespace lue {
    namespace {
        ...
        */
        hpx::future<std::string> id_to_str(hpx::id_type const id)
        {
        ...
        */
            ...
            -> hpx::future<std::string>
        {
            ...
            return hpx::when_all_n(std::begin(collection), std::size(collection))
                .then(
...
namespace lue {
    ...
    hpx::future<std::string> system_description()
    {
        ...
        hpx::future<std::string> description = hpx::dataflow(
